...
public class clientBR extends Application {
    ...
    private String useridLoggato;  // per tenere traccia dell'utente loggato
	...
	public void start(Stage stage) throws Exception {
	    ...
	    private Scene createMenuScene() {
	        ...
	        btnLogin.setOnAction(e -> primaryStage.setScene(loginScene));
	        btnRegister.setOnAction(e -> primaryStage.setScene(registrationScene));
	        
	        
	        btnViewBook.setOnAction(e -> visualizzaLibriUI(primaryStage));
	    ...
	    private Scene createRegistrationScene() {
	        ...
	        Label lblPassword = new Label("Password (deve contenere almeno 8 caratteri tra cui una lettera maiuscola, almeno una lettera minuscola, almeno un numero e almeno un carattere alfanumerico):");
	        PasswordField pfPassword = new PasswordField();
	        Label lblPasswordError = new Label(); lblPasswordError.setStyle("-fx-text-fill: red;");
	        ...
	        btnSubmit.setOnAction(e -> {
	            ...
	            if (!controlloPassword(password)) {
	                lblPasswordError.setText("Password non valida");
	                valid = false;
	            }
	    ...
	    // Metodi di controllo (versione per JavaFX)
	    ...
	    private Scene createPostLoginMenu() {
	        ...
	        // Azioni placeholder (puoi sostituire con vere scene o logica più avanti)
	        ...
	        btnRecommendBooks.setOnAction(e -> mostraFinestraConsigli());
	        btnViewBook.setOnAction(e->visualizzaLibriUI1(primaryStage));	        
	        btnBack.setOnAction(e -> primaryStage.setScene(menuScene));
	        ...
	        btnInvia.setOnAction(e -> {
	            ...
	            try {
	                ...
	                if (success) {
	                    ...
	                    lblMsg.setStyle("-fx-text-fill: red;");
	                    lblMsg.setText("Valutazione non inviata (possibilmente già esistente o dati invalidi).");
	                }
	    ...
	    private void mostraFinestraConsigli() {
	        try {
	            // Chiedi al server le librerie con libri dell'utente
	            out.writeObject("getLibrerieConLibriDiUtente");
	            out.writeObject(useridLoggato);
	            @SuppressWarnings("unchecked")
	            List<Libreria> librerie = (List<Libreria>) in.readObject();
	    ...
	    private Scene createRecommendBooksSelectionScene(List<Libreria> librerie, String libroDaConsigliare) {
	        ...
	        btnInvia.setOnAction(e -> {
	            ...
	            try {
	                ...
	                if (success) {
	                    ...
	                    lblMsgRisposta.setText("Consigli già inviati per questo libro o errore.");
	                    lblMsgRisposta.setStyle("-fx-text-fill: red;");
	                }
	        ...
	        btnBack.setOnAction(e -> {
	            // Torna alla scena iniziale di selezione libro da consigliare
